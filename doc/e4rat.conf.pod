...
/etc/e4head.conf - configuration file for the e4rat toolset

=head1 DESCRIPTION

B<e4head.conf> is the configuration file of the e4head binary. It allows to replace default parameters of the tools.
